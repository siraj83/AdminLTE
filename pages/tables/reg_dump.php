...
<head>
    ...
    <title> منصة مراقبة المكبات | تقرير البلديات المناطق المكبات</title>
            ...
            <div class="container-fluid">
                <div class="row" style="direction: rtl;text-align: center;display: block;margin-right: 250px;">
                    <div class="col-sm-6" style="text-align: left;">
                        <h1>بيانات البلديات المناطق المكبات</h1>
                    </div>
                    <!-- <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="row" style="direction: rtl;margin-right: 250px;">
                    <div class="col-12">
                            ...
                            <div class="card-body">
                                <table id="example1" name="example1" class="table table-bordered table-hover"
                                    ...
                                    <thead>
                                        <tr>
                                            <th>الاسم البلدية</th>
                                            <th>المناطق التابعة لها</th>
                                            <th>منطقة التخلص (المكب)</th>
                      ...
                      $sql = "SELECT mun.Mname, mun_nh.name, dumps.name as dname from municipalities as mun
                      INNER JOIN mun_nh as mun_nh
                      on mun.id = mun_nh.municipality
                      INNER JOIN dumps as dumps
                      on dumps.id = mun_nh.dump_id";
                      $result = $conn->query($sql);
                      if ($result->num_rows > 0) {
                        while ($row = $result -> fetch_array()){
                         echo '<tr data-value="2">' ;
                          echo  "<td>" . $row["Mname"] . "</td><td>" . $row["name"] . "</td><td>" . $row["dname"]."</td><td>"; ?>
