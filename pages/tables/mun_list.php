            ...
            <div class="container-fluid">
                <div class="row" style="direction: rtl;">
                    <div class="col-12">
                      ...
                      $sql = "SELECT municipalities.id,municipalities.Mname, municipalities.popu_ministry ,municipalities.popu_questionnaire, regions.name 
                      from municipalities LEFT JOIN regions on municipalities.region_id=regions.id";
                      $result = $conn->query($sql);
                      if ($result->num_rows > 0) {
                        while ($row = $result -> fetch_array()){
                         echo '<tr data-value="2">' ;
                          echo  "<td>" . $row["Mname"] . "</td><td>" . $row["Mname"] . "</td><td>" . $row["name"]."</td><td>" .$row["popu_ministry"]. "</td><td>" .$row["popu_questionnaire"]. "</td><td>"; ?>
